...
const Footer = () => {
	return (
		<div >
			<div className='flex flex-col lg:flex-row bg-black lg:h-60'>
				<div className='lg:w-1/2 ml-5 lg:ml-12 mt-5 lg:mt-10'>
					<p className='text-white text-2xl font-bold mb-3'>Turf's Corner</p>
					<p className='text-white mb-5 w-96 lg:w-1/2 text-justify'>Turf's Corner is an app where you can book turfs to play football and cricket with your friends and loved ones. Book a turf near you today! </p>
				</div>
			...
			<div className='bg-black py-4 flex flex-col lg:flex-row items-center justify-between border-t border-gray-400'>
