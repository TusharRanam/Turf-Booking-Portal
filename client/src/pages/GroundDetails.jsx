				...
				<div className='lg:w-1/2 lg:p-4 mt-8 lg:mt-4'>
					...
					<form onSubmit={bookGround} className='bg-gray-100 flex flex-col border border-gray-300 p-6 rounded-lg justify-center mb-4 shadow-md'>
						...
						{isLogin && <>
							<button
								type='submit'
								className='bg-green-600 hover:bg-green-700 text-white lg:w-32 px-4 py-2 rounded-lg mb-2'
							>
								Book
							</button>
						...
						{!isLogin && <button
							...
							className='bg-green-600 hover:bg-green-700 text-white lg:w-32 px-4 py-2 rounded-lg'
						>
							Login to book
						</button>}
					</form>
