...
//	const [authState, setAuthState] = useState('login');
    ...
    return (
	<>
	<div className='h-20 w-full  flex items-center p-8 font-bold text-4xl bg-black'>
	<h1 className='text-white font-serif'><span className='text-green-600'>Turf's</span> Corner</h1>
	</div>
		<div className=" bg-blue-50 flex flex-col lg:flex-row lg:h-screen justify-center ">
